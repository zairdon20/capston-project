/* const speakerData = [
    {
      ...
      Description: 'Chopra is a Clinical Professor of Family Medicine and Public
      Health at the University of California,
       San Diego and serves as a senior scientist with Gallup Organization.',
    },
    {
      ...
      Description: 'Russell Brand`s career spans stand-up comedy, acting,
      broadcasting and writing. He is the author of the Audible Original,
    ...
    },
    {
      ...
      Description: 'Jewel went from a homeless teenager in San Diego,
      to an award winning,
       Multi-Platinum Recording Artist who released one  of the best-selling debuts of all time.',
    },
    {
      ...
      Description: 'Dr. Cagle is an Aerospace Surgeon,
       entrepreneur and consulting professor for Stanford University`s department of cardiovascular
       medicine and its department of electrical engineering.',
    },
    {
      ...
      Description: 'Ranked amongst the fifty most influential people in India,
    ...
    },
    {
      ...
      Description: 'An actor who has never shied away from speaking his mind;
      a producer who doesn`t believe in the "formula",
      a film curator with a keen eye for detail and good stories',
    },
  ];
